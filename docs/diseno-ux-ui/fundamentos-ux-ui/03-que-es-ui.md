...
![¿Cómo Hacer Diseño UI?](./img/uxui-05.svg)
...
:::tip Guías útiles como referencia
...
**UI** *(User Interface)* — capa visual e interactiva por la que el usuario opera un producto digital.

**Guía de diseño** *(Design guideline)* — conjunto de reglas y tokens (color, tipografía, espaciados) que aseguran coherencia visual.

**Mockup** *(Mockup)* — representación visual detallada y estática de cómo se verá la interfaz.

**Prototipo** *(Prototype)* — maqueta interactiva que simula la navegación y comportamiento del producto.

**Accesibilidad** *(Accessibility)* — propiedad de una interfaz que la hace utilizable por personas con distintas capacidades; regulada por estándares como WCAG.

**Sistema de diseño** *(Design system)* — conjunto de componentes, reglas y documentación que permite escalar el diseño de un producto.

:::info Referencias primarias
- [Material Design](https://m3.material.io/) — sistema de diseño de Google.
- [Apple Human Interface Guidelines](https://developer.apple.com/design/human-interface-guidelines/) — referencia de interfaces de Apple.
- [W3C · WCAG 2.2](https://www.w3.org/TR/WCAG22/) — estándar de accesibilidad para contenido web.
:::
...
**Objetivo:** diseñar interfaces visuales coherentes y funcionales aplicando las prácticas base de UI.

**Entradas:**
- Guías de marca y tokens de diseño disponibles.
- Wireframes y flujos de UX ya definidos.
- Plataformas objetivo (web, móvil, escritorio).
- Herramientas de diseño y colaboración del equipo.

**Pasos:**
1. Definir guías de diseño: paleta, tipografía, layout, componentes.
2. Modelar flujos de navegación e interacción claros.
3. Elaborar mockups y prototipos interactivos para validación temprana.
4. Colaborar con UX y desarrollo para asegurar coherencia y viabilidad.
5. Revisar contra estándares de accesibilidad y lineamientos de plataforma.
6. Documentar decisiones para facilitar la extensión del sistema.

**Salidas:**
- Guía de diseño y mockups aprobados.
- Prototipo interactivo para validación.
- Especificaciones listas para implementación.

**Errores comunes:**
- Diseñar pantallas sin considerar guías ni tokens de la marca.
- Entregar mockups estáticos cuando el caso exige prototipo interactivo.
- Ignorar accesibilidad en tipografía y color.
- Trabajar aislado de UX o desarrollo y generar reprocesos.
