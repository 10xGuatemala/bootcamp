...
Complementaria al CHANGELOG: la plantilla `release-requirements.md` vive en [`examples-md/project/`](https://github.com/10xGuatemala/bootcamp/tree/main/examples-md/project) y documenta **una versión concreta** con sus requerimientos, repos afectados, migraciones de BD y checklist de release.
